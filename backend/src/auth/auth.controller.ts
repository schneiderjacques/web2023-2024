...
import { ApiBadRequestResponse, ApiBody, ApiNoContentResponse, ApiNotFoundResponse, ApiOkResponse, ApiParam, ApiResponse, ApiTags, ApiUnprocessableEntityResponse } from '@nestjs/swagger';
...
export class AuthController {
    ...
    constructor(private authService: AuthService,private _userService: UserService, private readonly confirmationService: ConfirmationService){}
   ...
   */
    ...
    async confirmEmail(@Query('token') token: string) {
      ...
      if (userId) {
        ...
        return 'E-mail confirmé avec succès.';
      } else {
        return 'Lien de confirmation invalide.';
      }
    }
